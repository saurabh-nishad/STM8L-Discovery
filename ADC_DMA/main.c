...
void main(void)
{
  ...
  while (1)
  {
    GPIO_WriteBit(LED_GR_PORT, LED_GR_PIN, SET);
  }
}
...
void showVoltage(int voltage)
{
  ...
  display_array[0] = voltage1000 + 48;
  display_array[0] |= DOT;
  display_array[1] = voltage100 + 48;
  display_array[2] = voltage10 + 48;
  display_array[3] = 'V';
  showBar(voltage);
  LCD_GLASS_DisplayStrDeci(display_array);
}
...
void showBar(int voltage)
{
  ...
  {
    BAR0_ON; BAR1_ON; BAR2_ON; BAR3_OFF;
  }
  if(voltage <= 2500 && voltage > 2000)
  {
    BAR0_ON; BAR1_ON; BAR2_OFF; BAR3_OFF;
  }
  if(voltage <= 2000 && voltage > 1500)
  {
    BAR0_ON; BAR1_OFF; BAR2_OFF; BAR3_OFF;
  }
  if(voltage <= 1500)
  {
    BAR0_OFF; BAR1_OFF; BAR2_OFF; BAR3_OFF;
  }
